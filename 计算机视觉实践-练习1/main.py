...
if __name__ == '__main__':
    ...
    # 读取拼接图片
    imageA = cv2.imread("./imgdata/img05.jpg")
    imageB = cv2.imread("./imgdata/img06.jpg")

    # 把图片拼接成全景图
    stitcher = Stitcher()
    (result, vis) = stitcher.stitch([imageA, imageB], showMatches=True)
    cv2.imwrite("./imgsave/img1.png", vis)
    cv2.imwrite("./imgsave/img2.png", result)
    end_time = time.time()
